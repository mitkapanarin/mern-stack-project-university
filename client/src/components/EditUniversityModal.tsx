...
const EditUniversityModal = () => {
  const universityData = useSelector((x: RootState) => x);
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="mb-6">
                <label htmlFor="address" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                  Enter your new address address
                </label>
                <input
                  onChange={onChange}
                  value={data.address}
              ...
              <div className="mb-6">
                <label htmlFor="faculties" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
